...
install_dependencies(){
    if check_sys packageManager yum; then
        ...
        yum_depends=(
            unzip gzip openssl openssl-devel gcc python-devel python-setuptools pcre pcre-devel libtool libevent
        ...
        apt_depends=(
            gettext build-essential unzip gzip python-setuptools curl openssl libssl-dev
